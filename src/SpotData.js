  ...
  return (
    <div>
      ...
      <select
        ...
        className="select"
      >
        <option value="" disabled={selectedSpotID !== null}>
          Beach Finder
        </option>
      ...
      {selectedSpotID !== null && (
        <div key={selectedSpotID} className="data-point fade-in">
          <p className="surf-spot">
            Beach Spot: {spotData[selectedSpotID].spot_name}
          </p>
          <p className="data-point">
            Latitude/Longitude: {spotData[selectedSpotID].coordinates[1]},{" "}
            {spotData[selectedSpotID].coordinates[0]}
          </p>
          <p className="data-point">
            Address: {spotData[selectedSpotID].street_address}
          </p>
        </div>
      )}
    </div>
